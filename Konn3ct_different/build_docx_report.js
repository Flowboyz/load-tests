...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      ...(data.uploaded_workers_count < data.total_expected_workers ? [
        new Paragraph({
          spacing: { before: 100, after: 140 },
          children: [
            new TextRun({
              text: `⚠️ [WARNING] Cluster Node Outage: Only ${data.uploaded_workers_count} of ${data.total_expected_workers} worker nodes completed and uploaded logs. The analytics in this report represent a subset of the targeted ${data.config?.bots || data.total_bots} bots due to node crashes or server disconnects.`,
              bold: true,
              color: RED
            })
          ]
